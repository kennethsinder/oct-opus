...
class Slicer:
    ...
    def fly_through(self, eye: np.ndarray, slice_indices: List[int], anti_aliasing=False) -> List[np.ndarray]:
        ...
        for slice_index in slice_indices:
            eye_slice = resize(eye[slice_index, :, :], self.__IMAGE_DIM, anti_aliasing=anti_aliasing)
    ...
    def multi_slice_sum(self, eye, lower, upper, anti_aliasing=False) -> np.ndarray:
        ...
        return resize(eye_summed, (self.__IMAGE_DIM, self.__IMAGE_DIM), anti_aliasing=anti_aliasing)
    ...
    def multi_slice_max_norm(self, eye: np.ndarray, lower, upper, anti_aliasing=False) -> np.ndarray:
        ...
        return resize(eye_norm, (self.__IMAGE_DIM, self.__IMAGE_DIM), anti_aliasing=anti_aliasing)
